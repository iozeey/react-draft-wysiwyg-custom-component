...
export const useRichTextEditorParams = (initialEditorState, {updateInfo, lastFocusKey}, menuItems, onChange) => {
  ...
  }, [editorState, lastFocusKey, ref, menuItems, updateInfo]);
  
  return {
    onClick, ref, keyBindingFn, handleKeyCommand, editorState, setEditorState, onEditorStateChange, onChange: _onChange
  };
};
